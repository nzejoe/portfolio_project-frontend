    ...
    const items = [
        {
            ...
            icon: <BsTruck className="text-5xl mx-auto text-primary" />,
        },
        {
            id: 2,
            title: "Free Returns",
            offer: "30 days free return policy",
            icon: <BsArchive className="text-5xl mx-auto text-primary" />,
        },
        {
            id: 3,
            title: "Secured Payments",
            offer: "Accept major credit cards",
            icon: <BsShieldCheck className="text-5xl mx-auto text-primary" />,
        },
        {
            id: 4,
            title: "Support Service",
            offer: "Top notch customer service",
            icon: <BsHeadset className="text-5xl mx-auto text-primary" />,
        },
    ];
    return (
        <div className="py-10">
                    ...
                    {items.map((service, idx) => (
                        <div key={service.id} className={"mb-5 text-center"}>
                            ...
                            <div className="">
                                ...
                                <p className="text-secondary/50">{service.offer}</p>
                            </div>
                        </div>
                    ))}
                </div>
